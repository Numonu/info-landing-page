...
export function SectionHeader() {
	...
	return (
		<header className="flex flex-col gap-2 transition-colors duration-200 xl:hover:bg-zinc-700 xl:p-2">
			<div className="h-[20rem] bg-cover lg:h-[48rem] bg-fixed md:bg-scroll" style={custom}></div>
			<h1
				className="text-main text-5xl font-bold uppercase">
				{data.header.title}
			</h1>
			<h2 className="text-xl font-bold uppercase tracking-widest">
				{data.header.subtitle}
			</h2>
			<h3 className="text-main text-2xl capitalize">
